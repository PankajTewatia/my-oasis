...
public class EventDispatcherServiceVertxEBProxy implements EventDispatcherService {
  private Vertx _vertx;
  private String _address;
  private DeliveryOptions _options;
  private boolean closed;

  public EventDispatcherServiceVertxEBProxy(Vertx vertx, String address) {
    this(vertx, address, null);
  }

  public EventDispatcherServiceVertxEBProxy(Vertx vertx, String address, DeliveryOptions options) {
    this._vertx = vertx;
  ...
  public EventDispatcherService pushEvent(EventProxy event, Handler<AsyncResult<JsonObject>> handler){
    ...
    _json.put("event", event != null ? event.toJson() : null);

    DeliveryOptions _deliveryOptions = (_options != null) ? new DeliveryOptions(_options) : new DeliveryOptions();
    _deliveryOptions.addHeader("action", "pushEvent");
    _deliveryOptions.getHeaders().set("action", "pushEvent");
  ...
  public EventDispatcherService push(JsonObject message, Handler<AsyncResult<JsonObject>> handler){
    ...
    DeliveryOptions _deliveryOptions = (_options != null) ? new DeliveryOptions(_options) : new DeliveryOptions();
    _deliveryOptions.addHeader("action", "push");
    _deliveryOptions.getHeaders().set("action", "push");
    _vertx.eventBus().<JsonObject>request(_address, _json, _deliveryOptions, res -> {
      if (res.failed()) {
        handler.handle(Future.failedFuture(res.cause()));
      } else {
  ...
  public EventDispatcherService broadcast(JsonObject obj, Handler<AsyncResult<JsonObject>> handler){
    ...
    DeliveryOptions _deliveryOptions = (_options != null) ? new DeliveryOptions(_options) : new DeliveryOptions();
    _deliveryOptions.addHeader("action", "broadcast");
    _deliveryOptions.getHeaders().set("action", "broadcast");
    _vertx.eventBus().<JsonObject>request(_address, _json, _deliveryOptions, res -> {
      if (res.failed()) {
        handler.handle(Future.failedFuture(res.cause()));
      } else {
