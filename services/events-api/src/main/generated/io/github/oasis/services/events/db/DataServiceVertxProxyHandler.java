...
public class DataServiceVertxProxyHandler extends ProxyHandler {
  ...
  public DataServiceVertxProxyHandler(Vertx vertx, DataService service, boolean topLevel, long timeoutInSecond){
    this(vertx, service, true, timeoutInSecond, false);
  }

  public DataServiceVertxProxyHandler(Vertx vertx, DataService service, boolean topLevel, long timeoutSeconds, boolean includeDebugInfo) {
      this.vertx = vertx;
